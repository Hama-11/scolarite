    ...
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute inset-0 overflow-y-auto">
        <div className="flex min-h-full items-start justify-center px-4 py-6 sm:py-10">
          <div className={`w-full bg-white rounded-lg text-left shadow-xl max-h-[92vh] flex flex-col ${sizes[size]}`}>
            {title && (
              <div className="px-4 pt-5 pb-4 sm:px-6 sm:pt-6 sm:pb-4 border-b shrink-0">
            ...
            <div className="px-4 py-5 sm:p-6 overflow-y-auto min-h-0">
              {children}
            </div>
          </div>
        </div>
